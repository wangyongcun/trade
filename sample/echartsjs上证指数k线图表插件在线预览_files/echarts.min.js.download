;console.log('源代码唯一下载链接: http://www.bootstrapmb.com/item/5531(当前备注仅在演示里出现，下载源码不包含) ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('stra')<0){location.href='http://www.bootstrapmb.com/item/5531'}};
/*
